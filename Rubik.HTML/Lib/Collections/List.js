...
(function (Rubik) {
    ...
    (function (Collections) {
        ...
        class List {
            ...
            */
            CopyTo(dest, offset = 0, count = this.Count()) {
            ...
            */
            Range(index, count = this.Count() - index) {
            ...
            */
            Sort(comparer = new Collections.ToStringComparer()) {

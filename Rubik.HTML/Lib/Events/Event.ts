...
module Rubik.Events
{
    ...
    */
    export class EventHandlerBase implements IEventHandler
    {
    ...
    */
    ...
    export class EventHandler<T extends EventArgs> extends EventHandlerBase
    {
        constructor(public Callback: (args: T) => void, public Context: any) {
    ...
    export class Event<T extends EventArgs> extends EventBase {
        Handlers: EventHandler<T>[] = [];

        Attach(handler: EventHandler<T>): void {
            super.Attach(handler);
        }
        Detach(handler: EventHandler<T>): void {
            super.Detach(handler);
        }

        IsAttached(handler: EventHandler<T>): boolean {

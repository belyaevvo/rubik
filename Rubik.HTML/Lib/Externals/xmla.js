    ...
    Xmla.prototype = {
        ...
        */
        request: function (options) {
            ...
            if (options.withCredentials) ajaxOptions.withCredentials = options.withCredentials; ///!!!
            if (options.headers) ajaxOptions.headers = options.headers;
            if (options.tag) ajaxOptions.tag = options.tag; ///!!!
            ...
            for (i = 0; i < numHierarchies; i++) {
                ...
                for (j = 0; j < numPropertyNodes; j++) {
                    ...
                    memberProperties[nodeName] = {
                        converter: _typeConverterMap[type ? type : "xsd:string"],

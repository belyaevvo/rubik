...
module Rubik.UI
{
    ...
    export var OnClickEventName: string = "click";
    export var OnMouseDownEventName: string = "mousedown touchstart";
    export var OnMouseUpEventName: string = "mouseup touchend";
    export var OnMouseMoveEventName: string = "mousemove touchmove";
    ...
    */
    ...
    $(document).on(OnMouseUpEventName, function (event: JQueryEventObject)
    {
    ...
    $(document).on(OnMouseMoveEventName, function (event)
    {

...
{    
    ...
    var AnimationCallbacks_Modified = function (eventArgs: Events.CollectionModifiedEventArgs<AnimationCallback>)
    {
    ...
    AnimationCallbacks.OnModified.Attach(new Events.CollectionModifiedEventHandler<AnimationCallback>(AnimationCallbacks_Modified, AnimationCallbacks));

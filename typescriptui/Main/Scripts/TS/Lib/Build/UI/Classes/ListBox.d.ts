...
/// <reference path="../../UI/Interfaces/IListBox.d.ts" />
/// <reference path="StackPanel.d.ts" />
declare module TSUI.UI {
    class ListBox<T> extends UI.StackPanel implements UI.IListBox<T> {
        public OnSelectionMade: TSUI.Events.SelectionMadeEvent;
        public OnSelectedIndexChange: TSUI.Events.SelectedIndexChangeEvent;
        public Items: TSUI.Collections.List<UI.IListItem<T>>;
        constructor();

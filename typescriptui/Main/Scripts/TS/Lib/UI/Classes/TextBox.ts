    ...
    export class TextBox extends Control implements ITextBox
    {
        ...
        ConstructDOM(parent: JQuery, onComplete:()=>void = null): void
        {
            ...
            super.ConstructDOM(parent, function ()
            {
                ...
                _this._TextInput.on("focus", function (event: JQueryEventObject)
                {
                    _this._TextInput_OnFocus(event);
                });
                _this._TextInput.on("blur", function (event: JQueryEventObject)
                {
                    _this._TextInput_OnBlur(event);
                });
                _this._TextInput.on("change, keyup", function (event: JQueryEventObject)
                {

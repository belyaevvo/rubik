...
module TSUI.UI
{
    export class Window extends Control implements IWindow
    {
        ...
        _MainTitleBar_OnMouseMove(eventArgs: Events.MouseMoveEventArgs)
        {
            if (this._DraggingWindow)
            {
                ...
                else
                {
                    ...
                    this.Top(new CSSNumber((y / parentHeight) * 100, "%"));
                    this.Left(new CSSNumber((x / parentWidth) * 100, "%"));
                }
        ...
        _MainResizeGrip_OnMouseMove(eventArgs: Events.MouseMoveEventArgs)
        {
            if (this._ResizingWindow)
            {
                ...
                else
                {
                    ...
                    this.Height(new CSSNumber(height, "%"));
                    this.Width(new CSSNumber(width, "%"));
                }
        ...
        Hide(callback: ()=>void = null, animator: Animation.IAnimator = new Animation.AppWindowAnimator()): void
        {
            ...
            super.Hide(function ()
            {
                ...
                _this.OnClose.Invoke(new Events.CloseEventArgs(this));

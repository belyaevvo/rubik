...
(function (TSUI) {
    (function (Apps) {
        ...
        (function (Samples) {
            var Sample16App = (function () {
                function Sample16App() {
                    this.MainContainer = null;
                    this.StartArgs = null;
                }
                Sample16App.prototype.Run = function (args, container) {
            ...
            Samples.Sample16App = Sample16App;

            

            /** This class would be auto-generated and put in the same separate file as the above interface. */
            var DesktopWindowDescription = (function (_super) {
                __extends(DesktopWindowDescription, _super);
                function DesktopWindowDescription() {
                    _super.call(this);
                    this.Description = {
                        Name: "",
                        ...
                        Children: [
                            {
                                ...
                                Type: AnimatedCanvas,
                                Properties: [
                                    { Name: "Width", Values: [new TSUI.UI.CSSNumber(90, "%")] },
                                    { Name: "Height", Values: [new TSUI.UI.CSSNumber(90, "%")] },
                                    { Name: "Top", Values: [new TSUI.UI.CSSNumber(5, "%")] },
                                    { Name: "Left", Values: [new TSUI.UI.CSSNumber(5, "%")] }
                                ],
                                Events: [
                    ...
                    TSUI.UI.ControlDescriptionLoader.LoadDescription(this.Description, this, null, this);
                }
                return DesktopWindowDescription;
            })(TSUI.UI.Window);
            ...
            */
            var DesktopWindow = (function (_super) {
                ...
                DesktopWindow.prototype.canvas_OnRendered = function (args) {
                    alert("OnRendered occurred!");
                };
                return DesktopWindow;
            })(DesktopWindowDescription);

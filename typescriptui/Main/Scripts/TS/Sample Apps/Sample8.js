...
(function (TSUI) {
    (function (Apps) {
        ...
        (function (Samples) {
            ...
            var Sample8App = (function () {
                function Sample8App() {
                    this.MainContainer = null;
                    this.StartArgs = null;
                }
                Sample8App.prototype.Run = function (args, container) {
                    ...
                    this.MainContainer.addClass("Sample8");
                ...
                Sample8App.prototype.InitSplashScreen = function () {
                    if (isMobile) {
                        this.TheSplashScreen = new TSUI.UI.MobileSplashScreen("Sample 8");
                    } else {
                        this.TheSplashScreen = new TSUI.UI.DesktopSplashScreen("Sample 8");
                        this.TheSplashScreen.Width(new TSUI.UI.CSSNumber(550));
                    }
                    this.TheSplashScreen.ConstructDOM(this.MainContainer);
                };
                Sample8App.prototype.ShowSplashScreen = function (callback) {
                ...
                Sample8App.prototype.Init = function (callback) {
                    if (typeof callback === "undefined") { callback = null; }
                    this.InitStartupWindow(callback);
                    return true;
                };
                Sample8App.prototype.InitStartupWindow = function (callback) {
                    if (typeof callback === "undefined") { callback = null; }
                    if (isMobile) {
            ...
            var StartupWindowControls = (function () {
                function StartupWindowControls(MobileMode, AWindow) {
                    ...
                    this.Tile1 = new TSUI.UI.Tile(MobileMode ? TSUI.UI.TileSizes.Small : TSUI.UI.TileSizes.Medium, TSUI.UI.TileTypes.Flip);
                    ...
                    this.Tile2 = new TSUI.UI.Tile(MobileMode ? TSUI.UI.TileSizes.Small : TSUI.UI.TileSizes.Medium, TSUI.UI.TileTypes.Flip);
                    ...
                    this.Tile3 = new TSUI.UI.Tile(MobileMode ? TSUI.UI.TileSizes.Small : TSUI.UI.TileSizes.Medium, TSUI.UI.TileTypes.Flip);
                    ...
                    this.Tile4 = new TSUI.UI.Tile(MobileMode ? TSUI.UI.TileSizes.Small : TSUI.UI.TileSizes.Medium, TSUI.UI.TileTypes.Flip);
                    ...
                    this.AboutTile = new TSUI.UI.Tile(MobileMode ? TSUI.UI.TileSizes.Medium : TSUI.UI.TileSizes.Large, TSUI.UI.TileTypes.Flip);
            ...
            var DesktopStartupWindow = (function (_super) {
                ...
                DesktopStartupWindow.prototype.ConstructDOM = function (parent, onComplete) {
                    ...
                    _super.prototype.ConstructDOM.call(this, parent, function () {
                        _this.WindowControls.AboutPage.ConstructDOM(parent);
            ...
            var MobileStartupWindow = (function (_super) {
                ...
                MobileStartupWindow.prototype.ConstructDOM = function (parent, onComplete) {
                    var _this = this;
                    _super.prototype.ConstructDOM.call(this, parent, function () {
                        _this.WindowControls.AboutPage.ConstructDOM(parent);

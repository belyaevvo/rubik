...
module TSUI.Apps.Samples
{
    ...
    export class Sample8App implements IApp
    {
        ...
        InitSplashScreen()
        {
            if (isMobile)
            {
                this.TheSplashScreen = new UI.MobileSplashScreen("Sample 8");
            }
            else
            {
                this.TheSplashScreen = new UI.DesktopSplashScreen("Sample 8");

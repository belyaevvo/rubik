...
(function (TSUI) {
    (function (Apps) {
        ...
        (function (Samples) {
            ...
            var Sample9App = (function () {
                function Sample9App() {
                    this.MainContainer = null;
                    this.StartArgs = null;
                }
                Sample9App.prototype.Run = function (args, container) {
                    ...
                    this.MainContainer.addClass("Sample9");
                    ...
                    console.log("Sample 9 loaded.");

                    this.TheCalcWindow = new CalculatorWindow(isMobile);
                    this.TheCalcWindow.ConstructDOM(this.MainContainer, function () {
                        _this.TheCalcWindow.Enabled(false);

                        if (isMobile) {
                            _this.TheCalcWindow.Top(new TSUI.UI.CSSNumber(0));
                            _this.TheCalcWindow.Left(new TSUI.UI.CSSNumber(0));
                        } else {
            ...
            var CalculatorWindow = (function (_super) {
                ...
                function CalculatorWindow(MobileMode) {
                    ...
                    this.ButtonClear.Text(MobileMode ? "Clr" : "Clear");

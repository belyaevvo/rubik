...
module TSUI.Apps.Samples
{
    ...
    export class Sample9App implements IApp
    {
        ...
        Run(args: string[]= [], container: JQuery = $("body")): void
        {
            ...
            this.TheCalcWindow.ConstructDOM(this.MainContainer, () =>
            {
                ...
                if (isMobile)
                {
                    this.TheCalcWindow.Top(new UI.CSSNumber(0));
                    this.TheCalcWindow.Left(new UI.CSSNumber(0));
                }
                else
                {
    ...
    class CalculatorWindow extends UI.Window
    {
        ...
        constructor(MobileMode: boolean = false)
        {
            super();

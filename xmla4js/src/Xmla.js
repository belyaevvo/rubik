...
/**
*   Can be used as value for header option in the options object passed to the
*   <code><a href="#method_request">request()</a></code> method to pass an optional header to the server.
*   @static
*   @final
*   @type string
*   @default Discover
